...
<head>
    ...
    <title>Student Management System (IT SOURCECODE)</title>
...
<header>
		<nav class="navbar navbar-dark bg-info navbar-expand-lg fixed-top" style="padding: 1rem 1rem;">
		<a class="navbar-brand col-md-2 col-sm-3" href="#"><i class="fa fa-graduation-cap"></i> Student Management System (IT SOURCECODE)</a>		
...
<div class="container-fluid">
	...
	<div class="row">
		...
		<nav class="col-md-2 d-none d-lg-block bg-dark sidebar" style="color: white">
        ...
        <li class="nav-item">
          <a href="<?php 
              ...
              class="nav-link active <?php if ($data['user_type']=='student'){ echo 'd-none'; } ?>">
            <i class="fas fa-user-graduate"></i> Student's List</a>
        </li>
        ...
        <li class="nav-item">
          <a href="<?php 
              ...
              class="nav-link active <?php if (($data['user_type']=='student')||($data['user_type']=='mentor')){ echo 'd-none'; } ?>">
            <i class="fas fa-chalkboard-teacher"></i> Mentor's List</a>
        </li>
